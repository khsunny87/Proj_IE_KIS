...
mat_cov<-c('Info_Male','Info_Age','PMH_DM','PMH_CKD','PMH_Malignancy','Lab_BL211103','Lab_BL3114','Lab_BL3119','Lab_BL3140') # survival
...
matched<-pre_match%>%
  ...
  matchit(as.formula(paste0('Mitral_Repair~',paste0(mat_cov,collapse='+'))),data=.,method="nearest",caliper=0.25,ratio=1)
